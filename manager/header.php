...
<div class="menu_1">
    ...
    <div class="menu_2">
        <li><a href="../상품관리/shop_list.php">상품보기</a></li>
        <li><a href="../manager/show_member.php">MEMBER</a></li>
        <?php if(!isset($_SESSION['userid'])){ ?>
        <li><a href="../Join/join_form.php">JOIN</a></li> <!-- 정보수정 --> 
        <li><a href="../Login/login_form.php">LOGIN</a></li> <!-- logout -->
        <li><a href="../index_3.php">고객사이트</a></li>
        <?php }else{ ?>
            <li><a href="../manager/manage_modify_form.php">PROFILE</a></li> <!-- 정보수정 -->
...
<div id="box1">
    <h1 style="margin-top:65px; margin-left:120px;">
        <a href="../manager/index_m.php" style="text-decoration:none;">
...
<div id="main_menu">
    ...
    <li><a href="../manager/show_pro_m.php"><p>MD</p></a></li>
    <li><a href="#"><p>ARTIST</p></a></li>
